            ...
            <div className="musics-container row">
                {isLoading ? (
                    Array.from({ length: 11 }).map((_, index) => (
                        <div key={index} className="col-md-2 col-sm-12 h-100 mb-5">
                    ...
                    musics.map((item) => (
                        <div key={item.id} className="col-md-4 col-lg-3 col-xl-2 col-sm-5 h-100 mb-5">
                            <Link to={`/musics/${item.id}`} className="text-white text-decoration-none h-100 d-block">
                                <div className="card bg-dark w-100 p-2">
